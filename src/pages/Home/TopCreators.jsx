        ...
        {creator.map((creatorsItem) => {
          return (
            <ScrollAnimation
              ...
              key={creatorsItem.id}
            >
              <div className=" bg-secondary rounded-xl p-4 flex md:flex-col items-center justify-evenly md:justify-center transition-all duration-300 hover:scale-105 hover:-translate-y-3 cursor-pointer">
                <div className="">
                  <div>
                    <img
